...
namespace API.Repository.Data
{
    public class EmployeeRepository : GeneralRepository<MyContext, Employee, string>
    {
        ...
        {
            var data = context.Employees.Where(x => x.Salary > 2000000).Count();
            var data1 = context.Employees.Where(x => x.Salary <= 2000000 && x.Salary >= 500000).Count();
            var data2 = context.Employees.Where(x => x.Salary > 500000).Count();
